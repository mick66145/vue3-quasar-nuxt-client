...
import InputTelVerify from './form/InputTelVerify.vue'
import InputTelCountryVerify from './form/InputTelCountryVerify.vue'
...
import InputMarriage from './form/InputMarriage.vue'
...
export default {
  install (app) {
    ...
    app.component('InputTelVerify', InputTelVerify)
    app.component('InputTelCountryVerify', InputTelCountryVerify)
    ...
    app.component('InputMarriage', InputMarriage)
