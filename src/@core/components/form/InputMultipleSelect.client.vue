<template>
  <q-select v-model="observeValue" multiple :options="filterOptions" :clearable="clearable" :outlined="outlined"
    :use-input="useInput" :use-chips="useChips" :map-options="mapOptions" :input-debounce="inputDebounce"
    :transition-show="transitionShow" :transition-hide="transitionHide" :option-label="optionLabelFn"
    :option-value="optionValueFn" :dense="dense" :rules="ruleList" @filter="filterFn" @clear="clearFn">
